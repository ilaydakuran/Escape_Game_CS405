...
{
    //glm::vec3 u = glm::vec3(glm::toMat4(glm::quat(glm::radians(rotation))) * glm::vec4(up, 1));
    //glm::vec3 f = glm::vec3(glm::toMat4(glm::quat(glm::radians(rotation))) * glm::vec4(front, 1));
